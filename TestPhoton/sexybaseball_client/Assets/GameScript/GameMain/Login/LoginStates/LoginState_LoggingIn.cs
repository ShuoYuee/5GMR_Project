...
public class LoginState_LoggingIn : ccMachineStateBase
{
    ...
    public override void f_Enter(object input)
    {
        ...
        //glo_Main.GetInstance().m_GameSocket.f_AddListener((int)SocketCommand.CS_UserLogin, new CMsg_LoginUserResp(), On_CMsg_LoginUserResp);
        ...
        if (string.IsNullOrWhiteSpace(StaticValue.m_strUsername) || string.IsNullOrWhiteSpace(StaticValue.m_strUserPwd))
        {
            isAutomatic = false;
            f_ManuelLogin();
        }
    ...
    private void f_LoginUser()
    {
        ...
        tCTG_AccountEnter.m_strAccount = StaticValue.m_strUsername;
