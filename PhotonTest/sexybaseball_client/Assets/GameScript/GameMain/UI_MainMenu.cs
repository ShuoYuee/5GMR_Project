...
namespace GameLogic
{
    public class UI_MainMenu : ccUILogicBase
    {
        ...
        private Text _InforText, _ScoreText, _TimeText;

        private bool _bLogOut = false;
        ...
        protected override void On_Init()
        {
            ...
            _TimeText = f_GetObject("TimeText").GetComponent<Text>();
        ...
        protected override void On_Close()
        {
            ...
            if (!_bLogOut)
            {
                OnClickBtn_Logout(null, null, null);
            }
        }
