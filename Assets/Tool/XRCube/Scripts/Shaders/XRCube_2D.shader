Shader "XRCube/XRCube_2D"
{
	...
	_Brightness("Brightness", Range(0, 10)) = 1
		...
		_distortionK1("distortion_K1", range(-1, 1)) = 0
		_distortionK2("distortion_K2", range(-1, 1)) = 0
		_distortionK3("distortion_K3", range(-1, 1)) = 0
		_scale("scale", range(0, 3)) = 1
		_reverse_X("reverse_X", range(0, 1)) = 0
