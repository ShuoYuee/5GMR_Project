...
public abstract class ListBoxBase : MonoBehaviour
{
	...
	[HideInInspector] public ListBoxBase lastListBox;
	[HideInInspector] public ListBoxBase nextListBox;
	private int _contentID;

	private ListPositionCtrl _positionCtrl;
	private ListBankBase _listBank;
	...
	private void UpdateDisplayContent()
	{
		...
		UpdateDisplayContent(_listBank.GetListContent(_contentID));
	}

    protected abstract void UpdateDisplayContent(object content);
