...
[System.Serializable]
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct CMsg_CTG_GuessResult : SockBaseDT
    {
        public SockBaseDT Clone()
        {
            SockBaseDT tGoodsPoolDT = (SockBaseDT)MemberwiseClone();
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct CMsg_CTG_GuessCommand : SockBaseDT
    {
        public SockBaseDT Clone()
        {
            SockBaseDT tGoodsPoolDT = (SockBaseDT)MemberwiseClone();
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct CMsg_CTG_GuessReGame : SockBaseDT
    {
        public SockBaseDT Clone()
        {
            SockBaseDT tGoodsPoolDT = (SockBaseDT)MemberwiseClone();
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct CMsg_CTG_GuessCallPlay : SockBaseDT
    {
        public SockBaseDT Clone()
        {
            SockBaseDT tGoodsPoolDT = (SockBaseDT)MemberwiseClone();
    ...
    //[StructLayout(LayoutKind.Sequential, Pack = 1)]
    //public struct CMsg_ItemInUse
    //{
    //    public int m_iItem;

    //    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)]
    //    public string m_szTimeUpDate;
    //}
