    ...
    public class UI_Login : ccUILogicBase
    {
        ...
        protected override void On_Open(object e)
        {
           ...
           // _textError.enabled = false;
            ...
            if (string.IsNullOrWhiteSpace(StaticValue.m_strAccount))
            {
            ...
            {
                // Automatic login.
                _inputFieldUsername.text = StaticValue.m_strAccount;
        ...
        {
            StaticValue.m_strAccount = f_GetUserName();
        ...
        public void f_ShowErrorV2(string strError)
        {
            _textError.text = strError;
            _imageLoop.enabled = false;
            f_EnableSelectables();
